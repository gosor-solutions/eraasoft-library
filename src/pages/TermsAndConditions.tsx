  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-10 lg:py-16 text-gray-800 leading-relaxed">
        ...
        <p className="mb-8">
          Welcome to Eknowledge. By accessing and using our website, you agree to comply with and be bound by the following terms and conditions. Please read them carefully before using our services.
        </p>
        ...
        <p className="mb-8">
          All content on this site, including text, graphics, logos, and images, is the property of Eknowledge and protected by intellectual property laws. You may not reproduce, distribute, or create derivative works without our written permission.
        </p>

        <h2 className="text-2xl font-bold mb-4 text-brand-primary">4. Limitation of Liability</h2>
        <p className="mb-8">
          Eknowledge shall not be liable for any direct, indirect, incidental, or consequential damages resulting from your use or inability to use our site or services.
        </p>
